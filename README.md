...
Simple Gradient Coloured Gym studio Landing Page
...
> to open Find & Replace across all files. Search for `Gym Max` and replace it with your brand name everywhere at once.
...
|----------------|-------------|------------------------------|
| Company name (`Gym Max`) | All `.html` files | Use Find & Replace to update it everywhere |
